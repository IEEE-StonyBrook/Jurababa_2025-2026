...
#define TOF_FRONT_WALL_THRESHOLD_MM 160.0f
...
// injected into the rotation PID. Search also keeps IMU heading hold active,
// so ToF steering should stay gentle and be treated as lateral trim.
//

...
Profile::Profile()
    : state_(State::Idle), speed_(0.0f), targetSpeed_(0.0f), finalSpeed_(0.0f), distance_(0.0f),
      startPosition_(0.0f), acceleration_(0.0f), invAcceleration_(1.0f), directionSign_(1)
{
}
...
{
    return std::fabs(speed_ * speed_ - finalSpeed_ * finalSpeed_) * 0.5f * invAcceleration_;
}